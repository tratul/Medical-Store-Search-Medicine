...
public class AddNewMedicine extends JFrame implements ActionListener
{
   ...
   l9.setBounds(470,220,200,25);
		...
		//l10.setFont(f);
  l10.setBounds(470,260,250,25);
    	jf.add(l10);

        t10 = new JTextField(20);
		t10.setBounds(720,260,130,25);t10.setToolTipText("Enter medicine rack no");
		jf.add(t10);
 ...
 ps=con.prepareStatement("insert into medicine (mbno,mname,mcompany,mqty,mexpdate,mpurdate,mtype,mpurprice,msaleprice,mrackno)values(?,?,?,?,?,?,?,?,?,?)");
