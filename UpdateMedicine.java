...
public class UpdateMedicine extends JFrame implements ActionListener
{
  ...
  l6.setBounds(470,100,200,25);
		...
		t6.setBounds(720,100,100,25);t6.setToolTipText("Enter medicine expiry date");
		jf.add(t6);
  ...
  l7.setBounds(470,140,220,25);
		...
		t7.setBounds(720,140,100,25);t7.setToolTipText("Enter medicine type");
		jf.add(t7);

		l8= new JLabel("Medicine purchase price*");
		//l8.setFont(f);
 l8.setBounds(470,180,200,25);
    	jf.add(l8);

        t8 = new JTextField(20);
		t8.setBounds(720,180,100,25);t8.setToolTipText("Enter medicine purchase price");
		jf.add(t8);

		l9 = new JLabel("Medicine sale price*");
	//	l9.setFont(f);
  l9.setBounds(470,220,200,25);
    	jf.add(l9);

        t9 = new JTextField(20);
		t9.setBounds(720,220,100,25);t9.setToolTipText("Enter medicine sale price");
		jf.add(t9);

		l10 = new JLabel("Medicine rack no*");
		//l10.setFont(f);
l10.setBounds(470,260,180,25);
    	jf.add(l10);

        t10 = new JTextField(20);
		t10.setBounds(720,260,100,25);t10.setToolTipText("Enter medicine rack no");
		jf.add(t10);
...
String str1="UPDATE medicine SET mbno='"+t1.getText()+"',mname='"+t2.getText()+"',mcompany='"+t3.getText()+"',mqty='"+t4.getText()+"',mexpdate='"+t5.getText()+"',mpurdate='"+t6.getText()+"',mtype='"+t7.getText()+"',mpurprice='"+t8.getText()+"',msaleprice='"+t9.getText()+"',mrackno='"+t10.getText()+"' where mbno='"+t1.getText()+"'or mname='"+t2.getText()+"'";
