...
class About extends JFrame
{
	...
	About()
	{
		...
		l1 = new JLabel("Medical Store Search Medicine");
		...
		l3 = new JLabel("Md. Mahmudul Hasan Bhuiyan");
		l3.setFont(new Font("Times New Roman",Font.BOLD,18));
		l3.setBounds(300,200,400,40);l3.setForeground(Color.red);
		jf.add(l3);

		l4 = new JLabel("Under the guidance of MD. EZAZUL ISLAM (Assistant Professor, FSIT, AIUB)");
		l4.setFont(new Font("Times New Roman",Font.BOLD,18));l4.setForeground(Color.red);
		l4.setBounds(100,250,800,40);
		jf.add(l4);


		l5 = new JLabel("We can upadte,delete & search the existing details.");
